...
def otp(emailid):
    ...
    mail.ehlo()
    mail.starttls()
    mail.login('manish4051k@gmail.com', 'xebbqatgvdvhzgrc')
...
conn = mysql.connector.connect(host='localhost',port='3306', user='root',password='password', database='airline')
        ...
        if a1 == otp_:
            ...
            if a2 == otp_:
                ...
                if a3 == otp_:
                    ...
                    print("You've exceeded the maximum number of tries. Please try again later.")
                    exit()
...
if ans==1:
    num = (input("\nEnter flight number:-"))
    headers=['SNO','AirlinesName','Departure','Destination','FlightNumber', 'TimeofDeparture', 'TimeofArrival', 'Charges']
...
def flight_data():   
    ...
    fli.append(fly)
    headers3 = ['SNO','AirlinesName','Departure','Destination','FlightNumber', 'TimeofDeparture', 'TimeofArrival', 'Charges']
